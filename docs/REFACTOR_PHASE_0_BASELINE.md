...
|---|---|---|---|
| Quality gate | Baseline commit `e82f218`, `npm.cmd run check`: 69 pass, 1 skip | Checkout `4cd00e6`, `npm.cmd ci` lalu `npm.cmd run check`: 113 pass, 1 skip MQTT | Syntax, ESLint, Postman, quality gate, test penuh, dan clean-install lulus; `git diff --check` juga lulus |
