...
|---|---|---|---|
| Quality gate | Baseline commit `e82f218`, `npm.cmd run check`: 69 pass, 1 skip | Checkout `4cd00e6`, `npm.cmd run check`: 113 pass, 1 skip MQTT | Syntax, ESLint, Postman, quality gate, dan test penuh lulus; clean-install belum menjadi bukti pada checkpoint ini |
