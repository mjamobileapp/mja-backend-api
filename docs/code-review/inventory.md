...
| Middleware | `auth.js`, `authMobile.js`, `authCombined.js`, `authorization.js` | Token verification dan owner/kasir scope | REVIEWED - HAS FINDING (REV-001, REV-021) |
...
| Utilities | `email.js`, `publicAuth.js`, `mqttClient.js`, `mqttStatusListener.js`, `password.js` | External integration, credentials, public reset response, ACK/status lifecycle, and listener cleanup | REVIEWED - HAS FINDING (REV-003, REV-015, REV-019, REV-022) |
...
| Controllers/models | cashflow, history, hargaCabang, transaksi | Business-critical mobile data, role scope, and transaction flow | REVIEWED - HAS FINDING (REV-014, REV-015, REV-017, REV-021); database-backed transaction, history, and cashflow flows covered, broker/device flow remains deferred |
