const BACKOFFICE_AUDIT_ACTIONS = Object.freeze({
  ...
  RESET_DEVICE: "RESET_DEVICE", RESET_PASSWORD: "RESET_PASSWORD", FORCE_RESET_PASSWORD: "FORCE_RESET_PASSWORD", UPDATE_ACCESS: "UPDATE_ACCESS", STATUS_CHANGE: "STATUS_CHANGE",
