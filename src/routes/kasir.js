...
router.get("/absensi", authenticateMobile, requireMobileOwner, KasirController.getAbsensiKasir);
...
router.post("/:email/resetpassword", publicPasswordResetRateLimiter, KasirController.resetPassword);
